          ...
          <div className="space-y-12">
            ...
            <section className="bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-lg">
              ...
              <p className="text-gray-600 dark:text-gray-300 leading-relaxed text-lg">
                Tera Talk（以下「当サイト」）は、ユーザーの個人情報の保護を重要な責務と考え、以下のプライバシーポリシーを定めています。
            ...
            <section className="bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-lg">
              <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-6">1. 収集する情報</h3>
              <div className="space-y-6">
                <div>
                  <h4 className="text-lg font-semibold text-gray-900 dark:text-white mb-3">1.1 自動的に収集される情報</h4>
                ...
                <div>
                  <h4 className="text-lg font-semibold text-gray-900 dark:text-white mb-3">1.2 ユーザーが提供する情報</h4>
                  <ul className="space-y-2 text-gray-600 dark:text-gray-300">
            ...
            {/* Usage Purpose */}
            <section className="bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-lg">
              <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-6">2. 情報の利用目的</h3>
              <div className="space-y-4">
                <div>
                  <h4 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">2.1 サービスの提供</h4>
                  <p className="text-gray-600 dark:text-gray-300">
                    AI僧侶との対話機能、仏教思想の学習コンテンツ、検索機能などのサービス提供
                  </p>
                </div>
                <div>
                  <h4 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">2.2 サービスの改善</h4>
                  <p className="text-gray-600 dark:text-gray-300">
                    ユーザーの利用状況を分析し、サイトの機能改善や新機能の開発
                  </p>
                </div>
                <div>
                  <h4 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">2.3 技術的な運用</h4>
                  <p className="text-gray-600 dark:text-gray-300">
                    サイトの正常な動作確保、セキュリティの維持、エラーの解決
                  </p>
                </div>
                <div>
                  <h4 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">2.4 統計情報の作成</h4>
                  <p className="text-gray-600 dark:text-gray-300">
            ...
            {/* Data Storage */}
            <section className="bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-lg">
              <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-6">3. データの保存と管理</h3>
              <div className="space-y-4">
                <div>
                  <h4 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">3.1 ローカルストレージ</h4>
                  <p className="text-gray-600 dark:text-gray-300">
                ...
                <div>
                  <h4 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">3.2 セッション情報</h4>
                  <p className="text-gray-600 dark:text-gray-300">
                    AI僧侶との対話内容は、セッション中のみ一時的に保存され、ページを離れると削除されます。
                  </p>
                </div>
                <div>
                  <h4 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">3.3 ログ情報</h4>
                  <p className="text-gray-600 dark:text-gray-300">
            ...
            <section className="bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-lg">
              <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-6">4. 第三者サービス</h3>
              <div className="space-y-4">
                <div>
                  <h4 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">4.1 Google Gemini API</h4>
                  <p className="text-gray-600 dark:text-gray-300">
                ...
                <div>
                  <h4 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">4.2 ホスティングサービス</h4>
                  <p className="text-gray-600 dark:text-gray-300">
            ...
            {/* User Rights */}
            <section className="bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-lg">
              <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-6">5. ユーザーの権利</h3>
              <div className="space-y-4">
                <div>
                  <h4 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">5.1 データの削除</h4>
                  <p className="text-gray-600 dark:text-gray-300">
                ...
                <div>
                  <h4 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">5.2 データの確認</h4>
                  <p className="text-gray-600 dark:text-gray-300">
                    ユーザーが提供した情報の確認や修正については、お問い合わせフォームからご連絡ください。
                  </p>
                </div>
                <div>
                  <h4 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">5.3 サービスの利用停止</h4>
                  <p className="text-gray-600 dark:text-gray-300">
            ...
            {/* Security */}
            <section className="bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-lg">
              <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-6">6. セキュリティ</h3>
              <div className="space-y-4">
                <div>
                  <h4 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">6.1 データの保護</h4>
                  <p className="text-gray-600 dark:text-gray-300">
                ...
                <div>
                  <h4 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">6.2 アクセス制限</h4>
                  <p className="text-gray-600 dark:text-gray-300">
            ...
            {/* Policy Updates */}
            <section className="bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-lg">
              <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-6">7. プライバシーポリシーの変更</h3>
              <p className="text-gray-600 dark:text-gray-300 leading-relaxed text-lg">
            ...
            {/* Contact */}
            <section className="bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-lg">
              <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-6">8. お問い合わせ</h3>
