  ...
  return (
    <PageLayout>
      ...
      <div className="text-center max-w-5xl mx-auto">
        ...
        {/* Feature Cards */}
        <div
          className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 lg:gap-12 px-4"
          role="region"
          aria-label="主要機能"
        >
          <Link
            ...
            aria-label="仏教思想を学ぶページへ移動"
          >
            <Card className="group-hover:transform group-hover:scale-105 h-full">
              <div
                className="w-12 h-12 sm:w-16 sm:h-16 rounded-xl flex items-center justify-center mb-6 sm:mb-8 mx-auto"
                style={{ backgroundColor: "var(--color-accent)" }}
                aria-hidden="true"
              >
                <BookOpen className="w-6 h-6 sm:w-8 sm:h-8 text-white" />
              </div>
              <h3 className="heading-tertiary mb-4 sm:mb-6 text-center">
                仏教思想を学ぶ
              </h3>
              ...
              <div
                className="flex items-center justify-center font-sans font-medium group-hover:translate-x-2 transition-transform duration-300 text-sm sm:text-base"
          ...
          <Link
            href="/sects"
            className="group fade-in sm:col-span-2 lg:col-span-1"
            style={{ animationDelay: "0.2s" }}
            aria-label="日本仏教宗派ページへ移動"
          >
            <Card className="group-hover:transform group-hover:scale-105 h-full">
              <div
                className="w-12 h-12 sm:w-16 sm:h-16 rounded-xl flex items-center justify-center mb-6 sm:mb-8 mx-auto"
